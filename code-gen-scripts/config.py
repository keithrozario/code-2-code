...
# Codmod Reports
CODMOD_REPORT_PATH = os.path.join(
    DOCS_DIRECTORY,
    "codmod_reports",
    "customized_report_money_note_detailed_journeys.md",
)
CODMOD_DATA_REPORT_PATH = os.path.join(
    DOCS_DIRECTORY, "codmod_reports", "customized_report_money_note_data_layer.md"
)
...
# Context Docs
ARCHITECTURE_PRINCIPLES_PATH = os.path.join(
    DOCS_DIRECTORY, "context_docs", "architecture_principles.md"
)

# Database Paths
DATABASE_DEFINITION_PATH = os.path.join(
    DOCS_DIRECTORY, "database_design", "database_definition.md"
)
...
API_DEPENDENCIES_PATH = os.path.join(
    DOCS_DIRECTORY, "api_design", "api_dependencies.md"
)
API_PLAN_PATH = os.path.join(DOCS_DIRECTORY, "api_design", "api_plan.md")
API_DETAIL_DESIGN_PATH = os.path.join(
    DOCS_DIRECTORY, "api_design", "api_detail_design.md"
)
...
# Taskmaster Paths
TASKMASTER_STATUS_FILE = os.path.join(
    WORKING_DIRECTORY, ".taskmaster", "current_status.md"
)
TASKMASTER_JSON_FILE = os.path.join(
    WORKING_DIRECTORY, ".taskmaster", "tasks", "tasks.json"
)
